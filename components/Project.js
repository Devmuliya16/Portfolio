    ...
    return (<>
        ...
        <div className="w-full m-2 bg-gray-400 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="group relative block overflow-hidden rounded-md transition-all duration-500">
                            ...
                            <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-all duration-500 backdrop-blur-lg flex items-center justify-center bg-white/50 dark:bg-slate-900 p-4 rounded shadow dark:shadow-gray-700">
                                <a href={data.Link} target='_blank' class="underline text-lg transition duration-500 font-medium">{data.title}  <BiLinkExternal className='inline-block fill-black dark:fill-white'/></a>
                            </div>
                        </div>
            ...
            <div className="p-5">
                ...
                <p class="m-2 font-normal text-gray-700 dark:text-gray-400">{data.about}</p>
